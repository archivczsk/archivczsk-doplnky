...
def http_endpoint_received( addon_id, endpoint, force, stop_service ):
	...
	# load actual settings and continue when received
	service_helper.getSettings(['orangetvuser', 'orangetvpwd', 'deviceid', 'enable_userbouquet', 'enable_adult', 'enable_xmlepg', 'player_name', 'enable_picons'], settings_received_bouquet, endpoint=endpoint, force=force, stop_service=stop_service )
